...
import edu.tvu.hotelbookingapp.model.dto.HotelSearchDTO;
import edu.tvu.hotelbookingapp.service.HotelSearchService;
...
public class HotelSearchController {
    ...
    @PostMapping("/search")
    public String findAvailableHotelsByCityAndDate(
            @Valid @ModelAttribute("hotelSearchDTO") HotelSearchDTO hotelSearchDTO,
        ...
        // ✅ Encode city để tránh Unicode lỗi Location header
        String encodedCity = URLEncoder.encode(hotelSearchDTO.getCity(), StandardCharsets.UTF_8);

        return String.format("redirect:/search-results?city=%s&checkinDate=%s&checkoutDate=%s",
                encodedCity, hotelSearchDTO.getCheckinDate(), hotelSearchDTO.getCheckoutDate());
    }
